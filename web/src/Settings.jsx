...
// TODO: adapt Settings for web; replace AsyncStorage with localStorage and remove native UI components.
...
export default function Settings() {
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert(
                "Success",
                "Decision history has been cleared successfully!",
              );
            } catch (e) {
              console.log(e);
  ...
  const handleEasterEgg = () => {
    ...
    if (eggCount + 1 === 5) {
      ...
      Alert.alert(
        "🎉 Developer Mode",
        "You found the secret! You are now officially a 'DeciMate Pro'. (This does nothing, but you feel cool now).",
      );
      setEggCount(0);
    }
  };
        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <Text style={styles.helperText}>
              {personality === "Strict"
                ? "Takes no excuses. Focuses purely on productivity."
                : personality === "Zen"
                  ? "Focuses on mental health and avoiding burnout."
            ...
            <Text style={styles.helperText}>
              Tell the AI about your preferences (e.g., &quot;I hate
              running,&quot; &quot;I prefer working at night&quot;).
            </Text>
            ...
            <TouchableOpacity activeOpacity={1} onPress={handleEasterEgg}>
              <Text style={styles.footerText}>
                DeciMate v1.2.0 • Powered by Gemini
              </Text>
            </TouchableOpacity>
          </ScrollView>
            ...
            >
              <View style={styles.modalContent}>
                ...
                <Text style={styles.modalSubtitle}>
                  ...
                  (e.g., &quot;I usually have low energy in the afternoons&quot;
                  or &quot;Prioritize coding over gaming.&quot;)
                </Text>
                <TextInput
